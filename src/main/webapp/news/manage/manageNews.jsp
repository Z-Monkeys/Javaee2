    		...
    		<table align="center" border="1">
    			...
    			<c:forEach items="${newses}" var="news">
    				<tr>
    					...
    					<td><c:out value="${news.getCaption()}"></c:out></td>
    					<td><c:out value="${news.getAuthor()}"></c:out></td>
    					<td><c:out value="${news.getNewsTime()}"></c:out></td>
    					<td>
    						<a href="javascript:void(0);" onclick="editNews(${news.getNewsId()})">编辑</a>
    					</td>
    					<td>
    						<a href="javascript:void(0);" onclick="deleteNews(${news.getNewsId()})">删除</a>
    					</td>
    				</tr>
    			</c:forEach>
    		</table>
